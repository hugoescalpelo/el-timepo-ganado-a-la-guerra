...
#define RX_PIN 4   // Conectar al TX del LD2420
#define TX_PIN 22   // Conectar al RX del LD2420

// Definir el WiFi y el broker MQTT
#define WIFI_SSID "HUAWEI_311_FA98"
#define WIFI_PASSWORD "RAADH00RLAM"
...
unsigned long sendIntervalLong = 10000;  // Intervalo para enviar '0' cada 5 segundos
int distanceThreshold = 120;  // Umbral de detección de distancia
