...
const char* ssid = "HUAWEI_311_FA98";
const char* password = "RAADH00RLAM";
...
IPAddress local_IP(192, 168, 8, 32);
...
const float batteryMinVoltage = 12.05;  // 20% del voltaje de la batería
